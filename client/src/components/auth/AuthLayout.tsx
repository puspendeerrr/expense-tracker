...
export const AuthLayout: React.FC<AuthLayoutProps> = ({ children }) => {
  return (
    <div className="min-h-screen bg-muted flex flex-col justify-between py-8 px-4 sm:px-6 lg:px-8">
      {/* Brand Header */}
      <header className="flex justify-center items-center py-4">
        <Link
          to="/"
          className="inline-flex items-center gap-2.5 text-foreground hover:opacity-90 transition-opacity"
        >
      ...
      <footer className="mt-8 text-center text-xs text-muted-foreground flex flex-col items-center gap-2">
